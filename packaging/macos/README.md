...
原生桌面 bundle 使用 `build-desktop-app.sh` 建立，`install-desktop.sh` 安裝至 `/Applications`。GitHub Actions 的 stable release 會以 Apple Developer ID codesign app、重新封裝 DMG、送交 notarization 並 stapling；prerelease bundle 維持未簽章。
